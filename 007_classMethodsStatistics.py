...
class BasketballTeam:
    ...
    def stats(self):  # méthode d'instance permettant d'afficher les statitiques de l'équipe de basketball
        return f"[BASKETBALL] STATS -> {self.name} : {utilities.pluriel(self.wins, 'victoire')} - " \
...
team_4 = BasketballTeam.from_file('C:/Users/LRCOM/Documents/Laurent/Python/Tuto@/TDN/Fichiers/Milwaukee.txt')  #
